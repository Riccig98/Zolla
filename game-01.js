...
const BUILDINGS={
 ...
 market:{name:"Mercato",icon:"▦",unlock:2,desc:"Cibo + merci → monete. Funziona meglio nei quartieri vivi.",cost:{coins:350,wood:25,stone:16},process:{inputs:{goods:.16,food:.10},outputs:{coins:1.55}},adj:{house:.13,park:.08,harbor:.12,bakery:.16,workshop:.16},specs:[{id:"bazaar",name:"Bazar",desc:"+35% ricavi.",effect:"bazaar"},{id:"wholesale",name:"Ingrosso",desc:"-25% consumo di input.",effect:"efficient"}]},
